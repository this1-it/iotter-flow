...
public class PdfFileBuilder extends FileBuilder {
	...
	public PdfFileBuilder(java.util.List<ExportRow> data, java.util.List<String> columnHeaders) {
		super(data, columnHeaders);
	}

	public PdfFileBuilder(java.util.List<ExportRow> data) {
	...
	protected void buildCell(Object value) {
		...
		if (value == null) {
			...
			cell = new PdfPCell(new Phrase(formatNumber((Number) value)));
		} else {
