...
//        	return ValidationResult.error(getTranslation("validators.group_is_mandatory_for_network_membership"));
//        }
//    	if (value == null){
...
//    		         return ValidationResult.error(getTranslation("validators.groups_belongs_to_different_networks"));
//    			}
//    		}
//        }
    	return ValidationResult.ok();
