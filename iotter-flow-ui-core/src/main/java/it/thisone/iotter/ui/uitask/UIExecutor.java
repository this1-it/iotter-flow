...
public interface UIExecutor {
	 ...
	 * thread and then accesses the UI to safely execute the UI update step of
	 * the runnable. The single future returned represents the entire background
	 * work and UI update task, therefore canceling the future may prevent the
	 * background work or the UI update depending on the state of the task at
	 * the time.
	 * 
	 * @param runnable
