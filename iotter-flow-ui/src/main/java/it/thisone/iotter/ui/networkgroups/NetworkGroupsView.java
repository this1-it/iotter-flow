...
@Route(value = "networkgroups", layout = MainLayout.class)
@PageTitle("Network Groups")
public class NetworkGroupsView extends BaseView {

	private static final long serialVersionUID = 1L;
	public static final String NAME = "networkgroups";

	private final ObjectProvider<NetworkGroupsListing> listingProvider;
	private final NetworkService networkService;
	private final AuthenticatedUser authenticatedUser;
	private boolean initialized;

	public NetworkGroupsView(ObjectProvider<NetworkGroupsListing> listingProvider, NetworkService networkService,
	...
	protected void onAttach(AttachEvent attachEvent) {
		...
		NetworkGroupsListing listing = listingProvider.getObject();
